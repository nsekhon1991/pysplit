...
!
! PROGRAM:     NAMAKARL          DECODE GRIB NAM (218) MODEL FIELD FOR HYSPLIT
!   PRGMMR:    GLENN ROLPH      ORG: REAR       DATE:01-11-15
!
! ABSTRACT:  THIS CODE WRITTEN AT THE AIR RESOURCES LABORATORY ...
!     converts nam model pressure grib file (12 km, 218) to arl packed format.
...
!                 15 Nov 2001 (GDR) - converted to nam 12 kmK
! LAST REVISED    28 Jul 2003 (BS)  - converted to nam 45 km AK grid #216
!
! USAGE: NAMAKARL [GRIB_FILE_NAME] [GRIB_FILE_NAME2] [...]
!   INPUT ARGUMENT LIST:
...
!     check for command line arguments
      narg=IARGC()
      if(narg.eq.0)then
         write(*,*)'Usage: namakarl [file_1] [file_2] [...]'
...
!   LAST REVISED: 28 Jul 2003 - BS  - nam AK grid #216
!
...
!     dimensions of eta 12 km grid 216 
!       /com/eta/prod/eta.YYYYMMDD/eta.tXXz.awipakXX.tm00

      PARAMETER (NLVL=27, MVAR=14, MAXX=139, MAXY=107, MAXB=60000)
      PARAMETER (MAXC=60000)
