...
!                 10 Nov 2005 (RRD) - fix error in wind rotation >150 hPa
...
! check for command line arguments
  ...
  IF(NARG.EQ.0)THEN
     WRITE(*,*)'Converts global AVN model GRIB1 files to ARL format.'
     WRITE(*,*)'Has been replaced by the more general program: grib2arl'
     WRITE(*,*)' '
