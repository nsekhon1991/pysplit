...
! 12 hours of forecast data will be processed with each execution
      ...
      NARG=IARGC()
      IF(NARG.LT.4)THEN
         WRITE(*,*)'Convert Navy COAMPS-2 output files to ARL format'
         WRITE(*,*)' '
...
! CHARACTER(80)     :: FNAME 
! INTEGER,PARAMETER :: NXP=72
! INTEGER,PARAMETER :: NYP=45
! REAL              :: RVAR(NXP,NYP), SVAR(NXP,NYP)

! FNAME= 'ensco/latitu_sfc_000000_000000_1a0061x0061_2002041100_00000000_fcstfld'
! FNAME='sample/latitu_sfc_000000_000000_1a0072x0045_1999090412_00000000_fcstfld'
! OPEN(10,FILE=FNAME,FORM='UNFORMATTED',ACCESS='DIRECT',RECL=(NXP*NYP*4))
! READ(10,REC=1)RVAR
! CLOSE (10)

! FNAME= 'ensco/longit_sfc_000000_000000_1a0061x0061_2002041100_00000000_fcstfld'
! FNAME='sample/longit_sfc_000000_000000_1a0072x0045_1999090412_00000000_fcstfld'
! OPEN(10,FILE=FNAME,FORM='UNFORMATTED',ACCESS='DIRECT',RECL=(NXP*NYP*4))
! READ(10,REC=1)SVAR
! CLOSE (10)
...
! DO I=1,NXP,(NXP-1)
! DO J=1,NYP,(NYP-1)
!    WRITE(*,'(2I5,2F10.2)')I,J,RVAR(I,J),SVAR(I,J)
! END DO
! END DO
