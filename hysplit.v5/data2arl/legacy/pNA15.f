...
!
! PROGRAM:     PMM52ARL         DECODE GRIB MM5 MODEL FIELD FOR HYSPLIT
...
!
! USAGE: PMM52ARL [GRIB_FILE_NAME] [GRIB_FILE_NAME2] [...]
!   INPUT ARGUMENT LIST:
...
!     number of levels, variables, and array limits
      PARAMETER (NLVL=25, MVAR=17, MAXX=342, MAXY=225, MAXB=350000)
