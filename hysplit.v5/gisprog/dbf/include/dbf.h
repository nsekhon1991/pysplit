/* 
 * $Source: /home/misc/greatdev/src/analysis/txt2dbf/include/RCS/dbf.h,v $
 * 
 * $Author: fkoorman $
 * 
 * $Revision: 1.2 $
...
/* NEW: 11.7.1997 define open flags depending on 
	OS to solve char 10 problems */
#ifdef DOS
#define OPENFLAGS	O_RDONLY
#define OPENNEWFLAGS	O_WRONLY | O_CREAT | O_TRUNC | O_BINARY

#else
#define	OPENFLAGS	O_RDONLY
#define OPENNEWFLAGS	O_WRONLY | O_CREAT | O_TRUNC
