...
c============================================================================= 
     ...
     +           task, iprint, ITERATE_OUT, csave, lsave, isave, dsave)
 
      character*60     task, csave
      character*80     ITERATE_OUT
      logical          lsave(4)
      integer          n, m, iprint, 
...
c       When iprint > 0, the file ITERATE_OUT will be created to
...
c-jlm-jn 
     ...
     +  wa(lwa),
     +  iwa(1),iwa(n+1),iwa(2*n+1),task,iprint,ITERATE_OUT,
...
c======================= The end of setulb =============================
     ...
     +                  iprint, ITERATE_OUT,csave, lsave, isave, dsave)
      implicit none
      character*60     task, csave
      character*80     ITERATE_OUT
      logical          lsave(4)
...
c           'info' records the termination information.
         ...
         itfile = 8
         if (iprint .ge. 1) then
c                                open a summary file ITERATE_OUT
            open (8, file = ITERATE_OUT, status = 'unknown')
         endif            
